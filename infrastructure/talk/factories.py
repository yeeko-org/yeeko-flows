...
from infrastructure.service.factories import ApiRequestFactory, InteractionTypeFactory
...
class InteractionFactory(DjangoModelFactory):
    ...
    api_requests = factory.RelatedFactoryList(
        ApiRequestFactory, 'interaction', size=3)
...
class EventFactory(DjangoModelFactory):
    ...
    api_request = optional_sub_factory(ApiRequestFactory)
