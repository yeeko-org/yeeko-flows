...
PIECES = [
    ...
    ("e", "e_corrige", "E4 corrige (captura libre)", "content"),
    ("e", "e_ia_corrige", "E4b ⚙️ corrige_por_ia", "content"),
    ("e", "e_checa_correccion", "E4c bifurca ia_completed", _D),
    ("e", "e_repregunta_correccion", "E4d repregunta corrección",
     "content"),
    ("e", "e_recalcula", "E4e ⚙️ calcula_salario_diario (recálculo)",
     "content"),
    ("e", "e_bifurca_correccion", "E4f bifurca correccion_destino", _D),
    ("e", "e_recalcula_tabulador",
     "E4g ⚙️ calcula_tabulador silencioso", "content"),
